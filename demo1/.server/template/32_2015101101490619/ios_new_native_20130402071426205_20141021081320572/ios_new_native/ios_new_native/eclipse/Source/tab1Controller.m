...
[main_customer setBackgroundImgFromPath:@"index-client-start.png" forState:UMP_Controls_State_Normal];
...
[main_product setBackgroundImgFromPath:@"index-product-normal.png" forState:UMP_Controls_State_Normal];
...
[main_order setBackgroundImgFromPath:@"index-bill-start.png" forState:UMP_Controls_State_Normal];
...
[main_action setBackgroundImgFromPath:@"index-action-start.png" forState:UMP_Controls_State_Normal];
...
[main_contract setBackgroundImgFromPath:@"index-relation-normal.png" forState:UMP_Controls_State_Normal];
...
[main_work setBackgroundImgFromPath:@"index-date-start.png" forState:UMP_Controls_State_Normal];
...
[main_lines setBackgroundImgFromPath:@"index-index-start.png" forState:UMP_Controls_State_Normal];
...
[main_chance setBackgroundImgFromPath:@"index-opp-start.png" forState:UMP_Controls_State_Normal];
...
[main_knowdge setBackgroundImgFromPath:@"index-knowledge-normal.png" forState:UMP_Controls_State_Normal];
